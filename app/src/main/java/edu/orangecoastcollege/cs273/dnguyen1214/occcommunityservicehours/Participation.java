...
public class Participation {
    ...
    private Participation(int id, int status, boolean validationRequested, float serviceHours, String responsibilities,
    ...
    public Participation(int status, boolean validationRequested, float serviceHours, String responsibilities,
                         User user, Event event)
    {
        this(-1,status,validationRequested,serviceHours,responsibilities,user,event);
    }
